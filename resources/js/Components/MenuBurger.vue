            ...
            <ul v-if="isOpen"
                ...
                <li @click="closeMenu">
                    <Link :href="route('login')"
                        class="inline-flex text-white bg-white bg-opacity-5 backdrop-blur-sm shadow-md py-2 px-24 focus:outline-none hover:bg-black rounded"
                ...
                <li @click="closeMenu">
                    <Link :href="route('register')"
                        class="inline-flex text-white bg-white bg-opacity-5 backdrop-blur-sm shadow-md  py-2 px-3 focus:outline-none hover:bg-black rounded"
                        style="box-shadow: 0 0 3px 2px #0ea5e9;">
                    Зарегистрироваться
                    </Link>
                </li>
